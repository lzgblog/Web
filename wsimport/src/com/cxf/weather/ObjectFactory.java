 ...
 * generated in the com.cxf.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://weathde.cxf.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://weathde.cxf.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.cxf.weather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weathde.cxf.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://weathde.cxf.com/", name = "queryWeather")
